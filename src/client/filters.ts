...
nw["landuse"="community_food_growing"];`,
  ...
  nwr["amenity"="kneipp_water_cure"];`,
    ...
    },
    {
      ...
      query: `
nwr["drinking_water"="yes"]["drinking_water:legal"!="no"];

nwr["amenity"="drinking_water"]["drinking_water:legal"!="no"];

node["amenity"="water_point"]["drinking_water:legal"!="no"];

nw["drinking_water:refill"="yes"]["drinking_water:legal"!="no"];`,
      color: "#4169E1",
      tags: [
...
way["highway"="footway"]["area"="yes"]["name"];`,
  ...
  nw["amenity"="hammock"];`,
    ...
    },
    {
      ...
      nw["amenity"="freeshop"]["clothes"!="no"]["give_box:policy"!="free_to_take"];`,
      color: "#FF7F50",
      tags: [
    ...
    },
    {
      ...
      nw["amenity"="freeshop"]["clothes"!="no"];`,
      color: "#FF7F50",
      tags: ["social_facility=clothing_bank", "amenity=give_box", "amenity=freeshop"],
      edit: ["amenity=social_facility", "amenity=give_box", "amenity"]
    },
    {
      id: 105,
      group: "goods",
    ...
    },
    {
      ...
      edit: ["amenity=recycling", "amenity=toy_library", "amenity=give_box", "amenity"]
    },
    {
      id: 115,
      group: "goods",
